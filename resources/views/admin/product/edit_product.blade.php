        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form class="form-horizontal" action="sua-san-pham-{{$product->id}}.html" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="box-body">
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Tên sản phẩm</label>
                                <div class="col-sm-10">
                                    <input name="name" type="text" class="form-control" id="name" placeholder="Tên sản phẩm" value="{{old('name',$product->name)}}" required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="category" class="form-control select2" style="width: 100%;">
                                        ...
                                        <option value="{{$v->id}}" {{(old('category',$product->id_category) == $v->id?'selected':'')}}>{{$v->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="price" type="text" class="form-control" id="price" placeholder="Giá sản phẩm" value="{{old('price',$product->price)}}" autocomplete="off">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <br>
                                    <image id="blah" src="{{url('/public/images/product/'.$product->img)}}" alt="Hình ảnh sản phẩm" width="122px" height="133px">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Mô tả</label>
                                <div class="col-sm-10">
                                    <textarea id="desc" name="desc" class="form-control" rows="10"  placeholder="Sơ lược về bài đăng" required>{{old('desc',$product->desc)}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input id="sale" name="sale" type="text" class="form-control" placeholder="giảm giá đơn vị VNĐ" value="{{old('sale',$product->sales)}}" autocomplete="off">
